    ...
    <>
      <Container className="m-9">
        <div>
          ...
          <li className="mb-2">
            <strong>Soft Skills that Rival My Hard Skills</strong> – While everyone being considered for this role likely has excellent technical skills, my experience has taught me that soft skills are equally, if not more, important. I excel at working with stakeholders to identify the root of a problem and crafting solutions that meet the needs of all parties. I’m also adept at communicating priorities clearly and explaining the rationale behind them, ensuring alignment across teams.
          </li>
          </ul>
        </div>
      </Container>
